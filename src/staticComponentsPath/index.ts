...
import {
  config as configLinkBox,
  editorConfig as editorConfigLinkBox,
} from "@/components/linkBox/config";
import {
  config as configImage,
  editorConfig as editorConfigImage,
} from "@/components/image/config";
import {
  config as configTitleText,
