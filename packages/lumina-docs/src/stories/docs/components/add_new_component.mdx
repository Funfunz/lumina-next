...
- **EditorButtonsContainer** - This component is used to easily have access to the editor options, like editing or deleting the component.
  This component will add a container to your component, containing editor buttons.
  It should receive, as props. the id and the config of the component (required). Others props are optional and accepted.
