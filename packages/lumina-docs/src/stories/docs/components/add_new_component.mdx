...
2. Create the component. It should created and exported and it will be available on Lumina. - see [Component](/docs/docs-components-add-new-component--documentation#component)
