...
The main purpose of this hook is to extend a component to have the possibility to the user to submit something with a enter on press, specifically while using `<Input />` component.
